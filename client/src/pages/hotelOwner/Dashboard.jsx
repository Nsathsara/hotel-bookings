...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align = 'left' font='outfit' title='Dashboard' subTitle="In one location, keep an eye on your hotel offerings, manage reservations, and examine earnings.  
      Keep yourself informed with real-time insights to guarantee seamless functioning."/>
