...
const AddRoom = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Title align = 'left' font='putfit' title='Add Room' subTitle='To improve the user booking experience, fill in the room features, 
      ...
      <div className='w-full flex max-sm:flec-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
            <p className='text-gray-800 mt-4'>Room Type</p>
            <select value={inputs.roomType} onChange={e=> setInputs({...inputs,roomType: e.target.value})} 
             id='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
