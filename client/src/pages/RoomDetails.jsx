    ...
    <div className='py-28 mg:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col lg:flex-row gap-6 mt-6'>
        <div className='lg:w-1/2 w-full'>
          <img src={mainImage} alt='Room-Image' className='w-full rounded-xl shadow-lg object-cover'/> {/* Main Image */}
        </div>
        <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>       {/* Other Images */}
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
          <h1 className='text-3xl md:text-4xl font-playfair'>Discover a whole new level of luxury</h1>
      ...
      shadow-[opx_opx_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'> Book Now
        </button>
      </form>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability. You get a comfortable two bedroom apartemnt
          has a true city feeling. The price quoted is for two guest, at the guest slot please mark the number of guests to get 
          the exact price for groups. The Guests wil be allocated ground floor according to availability. You get a comfortable 
          two bedroom apartemnt has a true city feeling. 
        </p>
      </div>
      ...
      <div className='flex flex-col items-start gap-4 '>
        <div className='flex flex-gap-4'>
          <img src={room.hotel.owner.image} alt='Host' className='h-14 w-14 mg:w-18 rounded-full'/>
          <div>
